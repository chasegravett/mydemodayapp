...
@Component({
  selector: 'app-questions30',
  templateUrl: './questions30.component.html',
  styleUrls: ['./questions30.component.css']
})
export class Questions30Component implements OnInit {
  ...
  public currentIndex: number = (Math.floor(Math.random() * 75)) + 481;
  interval$: any;
  ...
  getAnswers() {
    ...
    this.questionService.getQuestionJson()
      .subscribe(res => {
        for (let i = 0; i <= 3; i++) {
          let rand = (Math.floor(Math.random() * 75)) + 481;
